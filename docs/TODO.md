...
1. **Phase 1: 코드베이스 정렬** - 타입/라우트/네비게이션을 최신 문서에 맞게 수정
2. **Phase 9: Dev 메뉴** - MVP 검증을 위한 시나리오 데이터 및 시뮬레이터
3. **Phase 2-3: 탐색/행사 페이지** - 핵심 UI/UX 구현
4. **Phase 7: 인증** - Supabase Auth 연동
